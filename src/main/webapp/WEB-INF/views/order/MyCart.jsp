                        ...
                        <div class="main-profile ">
                            <div class="heading-section">
                                ...
                                <c:forEach var="ohr" items="${ohr }">
                                    <form class="getReservation" action="${pageContext.request.contextPath }/CartToMakeReservation" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 align-self-center">
                                            <div class="main-info header-text">
                                                ...
                                                <div class="main-border-button">
                                                    <a class="delete" onclick="deleteSubmit()">취소</a>
                                                </div>
                                                <div class="main-border-button">

                                                </div>
                                                <div class="main-button">
                                                    <a onclick="submit()">결제하기</a>
<%--                                                    <input type="submit" value="결제하기">--%>
                                        ...
                                        <div class="col-lg-4 align-self-center">
                                            <ul>
                                                ...
                                                <li>인원 수<span>${ohr.room_type}인</span></li>
                                            </ul>
                                        </div>
                                        <hr>
                                    </div>

                                        <input type="hidden" name="order_id" value="${ohr.order_id}">
                                        <input type="hidden" name="hotel_id" value="${ohr.hotel_id}">
                                        <input type="hidden" name="room_id2" value="${ohr.room_id2}">
...
<script>
    ...
    if (confirm("장바구니에서 삭제하시겠습니까?")){
        $(".getReservation").attr("action", "${pageContext.request.contextPath }/deleteFromCart");
        const form = document.querySelector(".getReservation");
        form.submit();
        }
